...
const LoginOTP = ({ formData, setFormData }) => {
  ...
  // let test = 'testingpasswordhashed';
  ...
  const verifyOtp = async () => {
    ...
    try {
      ...
      const config = {
        ...
        url: `${process.env.REACT_APP_API_ACCOUNT}pos/otp/existing`,
        method: 'POST',
        data: body,
      };
          ...
          <div className="flex-1">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="mt-5 text-gray-500 ">
                Kode OTP telah dikirimkan kepada Alamat Email <span className="text-blue-500">{formData.email}</span>
              </p>
            </div>
              ...
              <div className="mt-8">
                <div className="mt-6">
                  <div className="relative">
                    ...
                    <Input label="Kode OTP" type="email" name="email" placeholder="Enter your OTP" onChange={(e) => setOtp(e.target.value)} />
                  </div>
                </div>
...
export default HOC(LoginOTP, 'Login-required');
