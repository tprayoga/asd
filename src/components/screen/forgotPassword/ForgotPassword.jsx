...
const ForgotPassword = ({ forgotPasswordData, setForgotPasswordData }) => {
  ...
  const CheckEmailStatus = async (e) => {
    ...
    // console.log(TokenAuth, TokenAuthID);
    try {
      ...
      } else if (response.data.detail.status_code === 5 || 4) {
        setShow1(true);
        setMsgSuccess(<BsCheckCircleFill />);
        setTimeout(() => {
          setShow1(false);
          navigate('/forgot-password/method/otp');
        }, 2000);
      }
        ...
        <div className="flex mt-20 w-full max-w-md px-6 mx-auto lg:w-2/6 ">
          <div className="flex-1">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <h2 className="text-4xl font-bold text-center  text-black mt-10 lg:mt-28">Lupa password</h2>

              <p className="mt-3 text-gray-500 ">Silahkan masukan email akun anda untuk mereset password anda.</p>
            </div>
            <form onSubmit={CheckEmailStatus}>
              <div className="mt-8">
                <Input label="Email Address" type="email" name="email" placeholder="Example@mail.com" onChange={(e) => setForgotPasswordData({ ...forgotPasswordData, email: e.target.value })} />
                ...
                <div className="mt-6">
                  ...
                  >
                    Selanjutnya
                    {/* <Link to="/forgot-password/method/otp">Selanjutnya</Link> */}
                  </button>
                </div>
